...
from models.mask import faceBlendCommon as fbc
...
class Mask:
    def __init__(self):
        ...
        self.sigma = 50
        self.iter_filter_keys = iter(filters_config.keys())
        self.filters, self.multi_filter_runtime = load_filter(next(self.iter_filter_keys))
        self.VISUALIZE_FACE_POINTS = False
